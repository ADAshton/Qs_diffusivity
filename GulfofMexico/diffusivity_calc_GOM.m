...
outputFolder_waveclimate = ['/Users/rosepalermo/Documents/GitHub/Qs_diffusivity/GulfofMexico/WIS_GOM/waveclimate/'];
...
for i = 1:length(diffusivity)
    [diffusivity(i),WaveAngle(i)] = lookup_diffusivity(sl_az(i),wis_station(i),outputFolder_waveclimate,i,BarrierIsland(i));
end
